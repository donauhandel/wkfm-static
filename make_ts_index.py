...
try:
    client.collections["Wiener Merkantilprotokoll"].delete()
except ObjectNotFound:
    pass

current_schema = {
    "name": "Wiener Merkantilprotokoll",
    "fields": [
        {"name": "id", "type": "string"},
...
for x in tqdm(files, total=len(files)):
    ...
    for v in facs:
        ...
        pages += 1
        cfts_record = {
            "project": "Wiener Merkantilprotokoll",
        }
        record = {}
...
print(make_index)
print("done with cfts-index Wiener Merkantilprotokoll")
